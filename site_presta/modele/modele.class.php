...
public function selectReservationsByClientId($iduser) {
 ...
 ";
    ...
    public function insertReservation($tab) {
        $requete= "INSERT INTO reservation (idclient, idprestataire, idservice, date_reservation, heure_reservation, etat, commentaire) 
           
		        VALUES (:idclient, :idprestataire, :idservice, :date_reservation, :heure_reservation, :etat, :commentaire)";
        $tab['etat'] = 'en_attente';
